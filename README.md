...
**TPU Coder Cup Committee** is committed to building and maintaining a high-level TPU competition platform. The committee mainly sets up two departments, the **Case Department** and the **Publicity Department**. We are **eager** to find **like-minded partners** to **join us**! For more details, please refer to the link [TPU Coder Cup Committe Recruitment Notice](./docs/TPU%20Coder%20Cup%20Committee/README.md).
